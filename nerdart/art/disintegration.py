...
def probability(threshold) -> float:
    """
    The probability of any individual "pixel" being perturbed off the grid-like
    pattern, which is modulated by the `threshold` option. This function simply
    enforces that the passed option be a number between 0 and 1, inclusive.
    """
